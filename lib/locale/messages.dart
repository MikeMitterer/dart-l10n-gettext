...
final L10NTranslate translate = new L10NTranslate.withTranslations( {
   "de": {
      ...
      "Dirs to scan": "Ignoriere Verzeichnisse",
      "Example:": "Beispiele:",
      ...
      "mkl10n -l en,de . - Generates translation for en + de": "mkl10n -l en,de .    - Erstellt die Übersetzungen für en + de",
      "mkl10n . - Generates lib/locale/messages.dart": "mkl10n .             - Erstellt lib/locale/messages.dart",
      "not installed!": "",
      "Prints settings": "Zeigt die Settings an",
      "Settings:": "Einstellungen:",
      "Shows this message": "",
      "Test1": "",
      "Usage: mkl10n [options] <dir(s) to scan>": "Verwendung: mkl10n [optionen] <Scan-Verzeichnis>",
